            ...
            <div>
              ...
              <div class="stop-meta">
                <div class="stop-activity">
                  <span class="stop-meta-icon"><lord-icon src="public/assets/icons/lordicon/ibydboev.json" trigger="hover" colors="primary:#C9A84C,secondary:#9C7B3C" style="width:16px;height:16px"></lord-icon></span>
                  <span>${sact}</span>
                </div>
                ${sfood ? `
                <div class="stop-food">
    ...
    return `
      ...
      <div class="info-bar">
        <div class="info-bar-inner">
          ...
          <div class="info-item">
            <span class="info-item-icon"><lord-icon src="public/assets/icons/lordicon/dxjqoygy.json" trigger="hover" colors="primary:#C9A84C" style="width:20px;height:20px"></lord-icon></span>
