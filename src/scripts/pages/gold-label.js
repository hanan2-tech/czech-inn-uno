...
(function() {
  ...
  const tourIcons = {
    kafka:'<lord-icon src="public/assets/icons/lordicon/kipaqhoz.json" trigger="hover" colors="primary:#C9A84C" style="width:24px;height:24px"></lord-icon>',
    ...
    GOLD_LABEL.private_tours.forEach((tour, i) => {
      ...
      card.innerHTML = `
        ...
        <div class="gl-tour-card-bottom">
          ...
          <span class="gl-guests-pill"><lord-icon src="public/assets/icons/lordicon/dxjqoygy.json" trigger="hover" colors="primary:#C9A84C" style="width:16px;height:16px"></lord-icon> ${tour.guests}</span>
        </div>
      `;
