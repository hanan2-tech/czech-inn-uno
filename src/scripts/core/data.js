...
const TOURS = [
  {
    ...
    img: "public/assets/tours/kafka/hero.jpg",
    photos: [
      "public/assets/tours/kafka/gallery-1.jpg",
      "public/assets/tours/kafka/gallery-2.jpg",
      "public/assets/tours/kafka/gallery-3.jpg",
      "public/assets/tours/kafka/gallery-4.jpg",
      "public/assets/tours/kafka/gallery-5.webp"
    ],
    ...
    stops: [
      { n:"Old Town Square: Birthplace", a:"Staroměstské nám. 5", dur:"20 min",
        ...
        photo:"public/assets/tours/kafka/stop-1-old-town-square.jpg",
      ...
      { n:"Childhood Homes (3 addresses)", a:"Near Old Town Square", dur:"15 min",
        ...
        photo:"public/assets/tours/kafka/stop-2-josefov.jpg",
      ...
      { n:"Charles University: Law Faculty", a:"Ovocný trh 5", dur:"15 min",
        ...
        photo:"public/assets/tours/kafka/stop-3-university.jpg",
      ...
      { n:"Café Louvre: Coffee and Conversation", a:"Národní 22", dur:"45 min",
        ...
        photo:"public/assets/tours/kafka/stop-4-cafe-louvre.jpg",
      ...
      { n:"Golden Lane, Prague Castle", a:"Zlatá ulička, Pražský hrad", dur:"30 min",
        ...
        photo:"public/assets/tours/kafka/stop-5-golden-lane.jpg",
      ...
      { n:"Kafka Museum", a:"Cihelná 2b, Malá Strana", dur:"30 min",
        ...
        photo:"public/assets/tours/kafka/stop-6-kafka-museum.jpg",
      ...
      { n:"Vltava Riverbank: Final Reflection", a:"Cihelná Embankment", dur:"15 min",
        ...
        photo:"public/assets/tours/kafka/stop-7-vltava.jpg",
    ...
    venues: [
      ...
      { name:"Shakespeare & Sons", type:"English Bookshop", addr:"Krymská 12, Praha 10", what:"Beloved independent bookshop. Best selection of Prague literature in English. Staff picks are excellent.", tip:"Check their events calendar: readings happen regularly in the back room.", icon:'<lord-icon src="public/assets/icons/lordicon/kipaqhoz.json" trigger="hover" colors="primary:#C9A84C" style="width:20px;height:20px"></lord-icon>' },
  ...
  },
  {
    ...
    img: "public/assets/tours/mucha/hero.jpg",
    photos: [
      "public/assets/tours/mucha/gallery-1.jpg",
      "public/assets/tours/mucha/gallery-2.jpg",
      "public/assets/tours/mucha/gallery-3.jpg",
      "public/assets/tours/mucha/gallery-4.jpg",
      "public/assets/tours/mucha/gallery-5.jpg"
    ],
    ...
    stops: [
      { n:"Alfons Mucha Museum", a:"Panská 7, Praha 1", dur:"45 min",
        ...
        photo:"public/assets/tours/mucha/stop-1-mucha-museum.jpg",
      ...
      { n:"Kavárna Obecní dům, Municipal House", a:"nám. Republiky 5", dur:"50 min",
        ...
        photo:"public/assets/tours/mucha/stop-2-municipal-house.jpg",
      ...
      { n:"National Theatre", a:"Národní 2, Praha 1", dur:"25 min",
        ...
        photo:"public/assets/tours/mucha/stop-3-national-theatre.jpg",
      ...
      { n:"Wenceslas Square: Art Nouveau Walk", a:"Václavské nám.", dur:"20 min",
        ...
        photo:"public/assets/tours/mucha/stop-4-wenceslas.jpg",
      ...
      { n:"Charles Bridge: Inspiration Point", a:"Karlův most", dur:"30 min",
        ...
        photo:"public/assets/tours/mucha/stop-5-charles-bridge.jpg",
  ...
  },
  {
    ...
    img: "public/assets/tours/jewish/hero.jpg",
    photos: [
      "public/assets/tours/jewish/gallery-1.jpg",
      "public/assets/tours/jewish/gallery-2.jpg",
      "public/assets/tours/jewish/gallery-3.jpg",
      "public/assets/tours/jewish/gallery-4.jpg",
      "public/assets/tours/jewish/gallery-5.jpg"
    ],
    ...
    stops: [
      { n:"Josefov: Entering the Story", a:"Maiselova street, Praha 1", dur:"20 min",
        ...
        photo:"public/assets/tours/jewish/stop-1-josefov.jpg",
      ...
      { n:"Old-New Synagogue", a:"Maiselova 18, Praha 1", dur:"25 min",
        ...
        photo:"public/assets/tours/jewish/stop-2-old-new-synagogue.jpg",
      ...
      { n:"King Solomon Restaurant: Kosher Lunch", a:"Široká 8, Praha 1", dur:"50 min",
        ...
        photo:"public/assets/tours/jewish/stop-3-king-solomon.jpg",
      ...
      { n:"Old Jewish Cemetery", a:"Široká 3, Praha 1", dur:"25 min",
        ...
        photo:"public/assets/tours/jewish/stop-4-cemetery.jpg",
      ...
      { n:"Pinkas Synagogue: Walls of Names", a:"Široká 3, Praha 1", dur:"30 min",
        ...
        photo:"public/assets/tours/jewish/stop-5-pinkas.jpg",
    ...
    venues: [
      ...
      { name:"Prague Jewish Town Hall", type:"Cultural Site", addr:"Maiselova 18, Praha 1", what:"The only Jewish Town Hall in the world with two clocks: one Hebrew (running right to left), one Czech. A symbol of two identities coexisting.", tip:"The clock tower is visible from the street: look for it above the entrance.", icon:'<lord-icon src="public/assets/icons/lordicon/abgtphux.json" trigger="hover" colors="primary:#C9A84C" style="width:20px;height:20px"></lord-icon>' },
  ...
  },
  {
    ...
    img: "public/assets/tours/kids/hero.jpg",
    photos: [
      "public/assets/tours/kids/gallery-1.jpg",
      "public/assets/tours/kids/gallery-2.jpg",
      "public/assets/tours/kids/gallery-3.jpg",
      "public/assets/tours/kids/gallery-4.jpg",
      "public/assets/tours/kids/gallery-5.jpg"
    ],
    ...
    stops: [
      { n:"Old Town Square: The Magic Clock", a:"Staroměstské nám.", dur:"25 min",
        ...
        photo:"public/assets/extras/clock-tower.jpg",
      ...
      { n:"The Golem of Prague", a:"Old Jewish Cemetery area", dur:"30 min",
        lat:50.0897, lng:14.4170,
        photo:"public/assets/tours/kids/stop-2-golem.jpg",
      ...
      { n:"Charles Bridge: Statue Treasure Hunt", a:"Karlův most", dur:"30 min",
        lat:50.0865, lng:14.4118,
        photo:"public/assets/tours/kids/stop-3-charles-bridge.jpg",
      ...
      { n:"Angelato: World's Best Gelato", a:"Rytířská 27, Praha 1", dur:"30 min",
        ...
        photo:"public/assets/tours/kids/stop-4-gelato.jpg",
      ...
      { n:"Petřín Hill: Mirror Maze and Tower", a:"Petřín Hill, Praha 1", dur:"45 min",
        ...
        photo:"public/assets/tours/kids/stop-5-petrin.jpg",
      ...
      { n:"Puppet Theatre: Show and Workshop", a:"Žatecká 1, Praha 1", dur:"60 min",
        ...
        photo:"public/assets/tours/kids/stop-6-puppets.jpg",
...
const EXTRAS = [
  // Food & Drink
  { id:"beer-tour",     cat:"Food and Drink",  name:"Czech Food and Beer Tour",          desc:"Pub crawl through 3 historic Prague breweries with traditional Czech bites at each stop.",                    price:45, img:"public/assets/extras/beer-tour.jpg" },
  { id:"beer-spa",      cat:"Food and Drink",  name:"Beer Spa Experience",             desc:"Soak in a private oak barrel of hops & malt with unlimited cold beer from your own tap.",                   price:65, img:"public/assets/extras/beer-spa.jpg" },
  { id:"medieval",      cat:"Food and Drink",  name:"Medieval Dinner Show",            desc:"5-course feast with unlimited beer, fire dancers, jugglers, and swordfighting, a full spectacle.",          price:55, img:"public/assets/extras/medieval-dinner.jpg" },
  { id:"cooking-class", cat:"Food and Drink",  name:"Czech Cooking Masterclass",       desc:"Private cooking class with a Czech chef: svíčková, trdelník, and traditional dumplings from scratch.",    price:75, img:"public/assets/extras/cooking-class.jpg" },
  { id:"wine-cellar",   cat:"Food and Drink",  name:"Moravian Wine Cellar Tasting",    desc:"Guided tasting of 8 premium Moravian wines in a historic underground cellar with a sommelier.",           price:55, img:"public/assets/extras/wine-cellar.jpg" },
  // River & Water
  { id:"river-cruise",  cat:"River and Water", name:"Vltava Dinner Cruise",            desc:"2-hour scenic dinner cruise with live jazz, sunset views, and full Czech dinner service.",                   price:50, img:"public/assets/extras/river-cruise.jpg" },
  { id:"beer-bike",     cat:"River and Water", name:"Swimming Beer Bike",              desc:"Pedal-powered party boat on the Vltava, unlimited draft beer, great views, great laughs.",                 price:35, img:"public/assets/extras/beer-bike.jpg" },
  { id:"car-boat",      cat:"River and Water", name:"Antique Car Boat Ride",           desc:"Vintage-style car boat cruise past Prague's landmarks, charming and completely unique.",                   price:30, img:"public/assets/extras/car-boat.jpg" },
  { id:"paddle",        cat:"River and Water", name:"Paddle Boating",                  desc:"Relaxing paddle boat on the Vltava, unique perspective on Charles Bridge and the Castle.",                  price:15, img:"public/assets/extras/paddle-boat.jpg" },
  // Cultural
  { id:"castle-skip",   cat:"Cultural",      name:"Prague Castle Skip-the-Line",     desc:"VIP fast-track entry to the world's largest ancient castle complex. No queuing, ever.",                     price:25, img:"public/assets/extras/castle-skip.jpg" },
  { id:"clock-tower",   cat:"Cultural",      name:"Astronomical Clock Tower",        desc:"Private after-hours climb of the clock tower for panoramic views of Old Town Square at dusk.",              price:22, img:"public/assets/extras/clock-tower.jpg" },
  { id:"underground",   cat:"Cultural",      name:"Underground Prague",              desc:"Explore medieval cellars, tunnels, and secret corridors beneath Old Town, 700 years of history below.",   price:30, img:"public/assets/extras/underground.jpg" },
  { id:"communist",     cat:"Cultural",      name:"Communist Prague & Nuclear Bunker",desc:"Cold War tour: secret police cells, Velvet Revolution memorial & an actual nuclear bunker.",               price:35, img:"public/assets/extras/communist-tour.jpg" },
  { id:"concert",       cat:"Cultural",      name:"Classical Concert: Municipal House",desc:"Live symphony orchestra in Prague's stunning Art Nouveau concert hall. Dress code: smart.",              price:40, img:"public/assets/extras/concert.jpg" },
  { id:"opera",         cat:"Cultural",      name:"Opera at the State Opera",        desc:"World-class opera in a gorgeous neo-Rococo venue. Subtitles in 3 languages.",                               price:35, img:"public/assets/extras/opera.jpg" },
  { id:"lennon",        cat:"Cultural",      name:"Lennon Wall and Street Art Tour",   desc:"Guided walk through Prague's most expressive street art scene, the story of rebellion in colour.",         price:20, img:"public/assets/extras/lennon-wall.jpg" },
  { id:"vysehrad",      cat:"Cultural",      name:"Vyšehrad Fortress Walk",          desc:"Panoramic views, ancient basilica, and the cemetery where Czech legends are buried.",                       price:20, img:"public/assets/extras/vysehrad.jpg" },
  { id:"glassblowing",  cat:"Cultural",      name:"Czech Glass Blowing Workshop",    desc:"Create your own glass piece with a master glassblower in a Bohemian studio. Keep your creation.",         price:55, img:"public/assets/extras/glassblowing.jpg" },
  { id:"photoshoot",    cat:"Cultural",      name:"Old Town Photography Session",    desc:"2-hour shoot with a professional photographer in Prague's most photogenic locations, at golden hour.",    price:120, img:"public/assets/extras/photoshoot.jpg" },
  // Day Trips
  { id:"bohemia",       cat:"Day Trips",     name:"Bohemian Switzerland",            desc:"Full-day hike: Pravčická Gate arch, Edmund Gorge boat ride, pine forest trails.",                           price:85, img:"public/assets/extras/bohemia.jpg" },
  { id:"krumlov",       cat:"Day Trips",     name:"Český Krumlov",                   desc:"UNESCO fairy-tale castle town: castle tour, river rafting, medieval tavern lunch.",                        price:75, img:"public/assets/extras/krumlov.jpg" },
  { id:"kutna",         cat:"Day Trips",     name:"Kutná Hora & Bone Church",        desc:"Sedlec Ossuary (the famous bone church), St. Barbara's Cathedral, silver mining history.",                 price:60, img:"public/assets/extras/kutna-hora.jpg" },
  { id:"karlovy",       cat:"Day Trips",     name:"Karlovy Vary Spa Town",           desc:"Hot springs, Moser crystal glass factory, Becherovka distillery tasting, thermal spa.",                   price:70, img:"public/assets/extras/karlovy-vary.jpg" },
  // Adventure
  { id:"segway",        cat:"Adventure",     name:"Segway / E-Scooter Tour",         desc:"Glide through Prague's hidden districts and riverside paths, away from tourist crowds.",                  price:40, img:"public/assets/extras/segway.jpg" },
  { id:"ebike",         cat:"Adventure",     name:"E-Bike River Trail",              desc:"Scenic cycling along the Vltava with stops at local riverside beer gardens.",                               price:35, img:"public/assets/extras/ebike.jpg" },
  { id:"helicopter",    cat:"Adventure",     name:"Helicopter Tour of Prague",       desc:"15-minute private helicopter flight over Prague Castle, Old Town, and the Vltava. Unforgettable.",        price:220, img:"public/assets/extras/helicopter.jpg" }
];
...
const AFTER_DARK = {
  jazz: [
    { name:"Jazz Dock", addr:"Janáčkovo nábřeží 2, Praha 5", type:"Jazz Club", desc:"Prague's finest jazz club, built directly on the Vltava riverbank. Live jazz nightly from 9pm. Book the riverside table for the best view.", price_from:15, img:"public/assets/venues/jazz-club.jpg", tip:"The whisky selection is exceptional: 80+ single malts. Arrive by 8:30pm for the best seats." },
    { name:"AghaRTA Jazz Centrum", addr:"Železná 16, Praha 1", type:"Jazz Club", desc:"Old Town's legendary jazz basement. Running since 1991, it's a Prague institution. Traditional and fusion jazz every night from 9pm.", price_from:12, img:"public/assets/venues/jazz-club.jpg", tip:"The Thursday night jam sessions are legendary. Check the website for headline acts." },
    { name:"Reduta Jazz Club", addr:"Národní 20, Praha 1", type:"Jazz Club", desc:"Prague's oldest jazz club, opened in 1958. President Clinton played here in 1994. Historic, intimate, unmissable.", price_from:14, img:"public/assets/venues/jazz-club.jpg", tip:"Book online: it sells out. The Dixieland nights on Fridays are extraordinary." }
  ],
  rooftop: [
    { name:"T-Anker Rooftop Bar", addr:"nám. Republiky 8, Praha 1", type:"Rooftop Bar", desc:"360° panoramic view of Old Town from a rooftop terrace. Best sunset view in the city. Czech craft beers and creative cocktails.", price_from:12, img:"public/assets/venues/rooftop-bar.jpg", tip:"Go at 7pm for golden hour. The Municipal House dome is directly opposite." },
    { name:"Cloud 9 Sky Bar and Lounge", addr:"Pobřežní 1, Praha 8 (Hilton)", type:"Sky Bar", desc:"Hilton's rooftop bar, sophisticated, quiet, and with arguably the best view of the Vltava from any bar in Prague.", price_from:15, img:"public/assets/venues/rooftop-bar.jpg", tip:"Dress code applies after 9pm. The espresso martini is their signature." },
    { name:"Estrella Sky Bar", addr:"Zlatnická 12, Praha 1", type:"Rooftop Bar", desc:"Open-air rooftop with a view over Charles Bridge and Prague Castle. Fire pits in winter. One of the most romantic bars in Europe.", price_from:14, img:"public/assets/venues/rooftop-bar.jpg", tip:"Book the VIP section for groups of 4+. The table service is excellent." }
  ],
  cocktail_bars: [
    { name:"Hemingway Bar", addr:"Karoliny Světlé 26, Praha 1", type:"Cocktail Bar", desc:"Prague's most celebrated cocktail bar. Pre-Prohibition recipes, fresh ingredients, and an atmosphere that feels genuinely 1930s. Flawless.", price_from:16, img:"public/assets/venues/cocktail-bar.jpg", tip:"No reservations: queue is worth it. The Hemingway Daiquiri is non-negotiable. Ask the barman about the gin collection." },
    { name:"Black Angel's Bar", addr:"Staroměstské nám. 29, Praha 1", type:"Cocktail Bar", desc:"Hidden underground bar beneath the Old Town. Gothic arches, candlelight, and some of the most creative cocktails in Central Europe. Theatrical.", price_from:14, img:"public/assets/venues/cocktail-bar.jpg", tip:"Try the Absinthe ceremony: a genuine Czech absinthe ritual performed tableside." },
    { name:"Banker's Bar", addr:"Senovážné nám. 5, Praha 1", type:"Cocktail Bar", desc:"1920s banking hall converted into a bar of extraordinary elegance. Marble columns, brass fittings, and a cocktail menu that changes monthly.", price_from:15, img:"public/assets/venues/cocktail-bar.jpg", tip:"The bar food is exceptional: the wagyu sliders at midnight are remarkable." }
  ],
  shows: [
    { name:"Czech Medieval Tavern", addr:"Mostecká 21, Praha 1", type:"Dinner Show", desc:"Theatrical 5-course medieval feast with fire eaters, jesters, live music and sword fights. Unlimited mead and beer. A complete spectacle.", price:55, img:"public/assets/extras/medieval-dinner.jpg", tip:"Book the VIP table near the stage for the best show. Vegetarian menu available on request." },
    { name:"Black Light Theatre Image", addr:"Pařížská 4, Praha 1", type:"Theatre", desc:"Prague's world-famous Black Light Theatre, an optical illusion performance unlike anything else in Europe. No language barrier. All ages.", price:28, img:"public/assets/venues/black-light-theatre.jpg", tip:"Sit in the centre of the stalls, not the sides. The 3D effects only work from the front." }
  ]
};
