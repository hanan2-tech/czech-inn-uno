...
const TOURS = [
  {
    ...
    img: "https://images.unsplash.com/photo-1458150945447-7fb764c11a92?auto=format&fit=crop&w=900&q=80",
    ...
    stops: [
      { n:"Old Town Square — Birthplace", a:"Staroměstské nám. 5", dur:"20 min",
        story:"Kafka was born July 3, 1883 in this very square — to a middle-class Jewish family, torn between Czech, German, and Jewish identity. He grew up under a domineering father who never understood him.",
        ...
        photo:"Kafka birthplace plaque + square panorama" },
      { n:"Childhood Homes (3 addresses)", a:"Near Old Town Square", dur:"15 min",
        story:"His family moved repeatedly — each apartment a reflection of his father's ambition, and Franz's quiet resistance. He lived in at least 5 apartments in this same neighborhood.",
        quote:'"I am made of literature."',
        activity:"Look at the buildings. Imagine the same streets at night, in 1905.",
        photo:"Kafka family addresses, wall plaques" },
      { n:"Charles University — Law Faculty", a:"Ovocný trh 5", dur:"15 min",
        story:"Studied law 1901–1906. Not from passion — from compromise with his father. Led a complete double life: insurance clerk by day, writer by night. Few colleagues knew who he truly was.",
        ...
        photo:"University gate and courtyard" },
      { n:"Café Louvre — Coffee & Conversation", a:"Národní 22", dur:"45 min",
        ...
        photo:"Art Nouveau café interior, antique coffee tables",
      ...
      { n:"Golden Lane — Prague Castle", a:"Zlatá ulička, Pražský hrad", dur:"30 min",
        ...
        photo:"Colorful tiny houses of Golden Lane" },
      { n:"Kafka Museum", a:"Cihelná 2b, Malá Strana", dur:"30 min",
        ...
        photo:"Museum exhibit hall, original manuscripts" },
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1543168256-ba36c0f07b6b?auto=format&fit=crop&w=900&q=80",
    ...
    stops: [
      { n:"Alfons Mucha Museum", a:"Panská 7, Praha 1", dur:"45 min",
        ...
        photo:"Central hall with iconic poster series" },
      { n:"Kavárna Obecní dům — Municipal House", a:"nám. Republiky 5", dur:"50 min",
        ...
        photo:"Kavárna interior, Mucha-designed Mayor's Hall",
      ...
      { n:"National Theatre", a:"Národní 2, Praha 1", dur:"25 min",
        ...
        photo:"Theatre façade, ornamental windows and gold dome" },
      { n:"Wenceslas Square — Art Nouveau Walk", a:"Václavské nám.", dur:"20 min",
        ...
        photo:"Hotel Europa façade, street-level ornaments" },
      { n:"Charles Bridge — Inspiration Point", a:"Karlův most", dur:"30 min",
        ...
        activity:"Find the lucky bronze dog on St. John of Nepomuk — touch it for luck.",
  ...
  {
    id: "jewish", name: "Jewish Prague — Heritage & Continuity",
    ...
    stops: [
      { n:"Josefov — Entering the Story", a:"Maiselova street, Praha 1", dur:"20 min",
        ...
        photo:"Josefov streets, Art Nouveau buildings over ancient foundations" },
      { n:"Old-New Synagogue", a:"Maiselova 18, Praha 1", dur:"25 min",
        ...
        photo:"Gothic facade, interior bimah and ark" },
      { n:"King Solomon Restaurant — Kosher Lunch", a:"Široká 8, Praha 1", dur:"50 min",
        ...
        photo:"Beautifully set traditional restaurant tables",
      ...
      { n:"Old Jewish Cemetery", a:"Široká 3, Praha 1", dur:"25 min",
        ...
        photo:"Ancient layered headstones, moss-covered, sunlight through trees" },
  ...
  {
    id: "kids", name: "Prague Legend Quest — Kids & Families",
    sub: "Adventure · Imagination · Legends · Ice Cream",
    badge: "KIDS", badgeClass: "bg-kids",
    img: "https://images.unsplash.com/photo-1513805959324-96eb66ca8713?auto=format&fit=crop&w=900&q=80",
    ...
    stops: [
      { n:"Old Town Square — The Magic Clock", a:"Staroměstské nám.", dur:"25 min",
        ...
        photo:"Clock in action, family photo spot",
        food:"" },
      { n:"The Golem of Prague", a:"Old Jewish Cemetery area", dur:"30 min",
        ...
        photo:"Kids with their clay Golem creations",
        food:"Cookies & juice for all children" },
      { n:"Charles Bridge — Statue Treasure Hunt", a:"Karlův most", dur:"30 min",
        ...
        photo:"Kids touching the lucky statue, treasure hunt poses" },
      { n:"Angelato — World's Best Gelato", a:"Rytířská 27, Praha 1", dur:"30 min",
        ...
        photo:"Kids with oversized colourful gelato cones",
        food:"2 scoops + 1 topping per child, unlimited sprinkles" },
      { n:"Petřín Hill — Mirror Maze & Tower", a:"Petřín Hill, Praha 1", dur:"45 min",
        ...
        photo:"Kids in mirror maze, panoramic tower views" },
      { n:"Puppet Theatre — Show & Workshop", a:"Žatecká 1, Praha 1", dur:"60 min",
        ...
        photo:"Colourful puppet stage, children painting their puppets",
...
const EXTRAS = [
  // Food & Drink
  { id:"beer-tour",     cat:"Food & Drink",  name:"Czech Food & Beer Tour",          desc:"Pub crawl through 3 historic Prague breweries with traditional Czech bites at each stop.",                    price:45, img:"https://images.unsplash.com/photo-1535958636474-b021ee887b13?auto=format&fit=crop&w=600&q=80" },
  { id:"beer-spa",      cat:"Food & Drink",  name:"Beer Spa Experience",             desc:"Soak in a private oak barrel of hops & malt with unlimited cold beer from your own tap.",                   price:65, img:"https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&w=600&q=80" },
  { id:"medieval",      cat:"Food & Drink",  name:"Medieval Dinner Show",            desc:"5-course feast with unlimited beer, fire dancers, jugglers, and swordfighting — a full spectacle.",          price:55, img:"https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=600&q=80" },
  { id:"cooking-class", cat:"Food & Drink",  name:"Czech Cooking Masterclass",       desc:"Private cooking class with a Czech chef — svíčková, trdelník, and traditional dumplings from scratch.",    price:75, img:"https://images.unsplash.com/photo-1556910103-1c02745aae4d?auto=format&fit=crop&w=600&q=80" },
  { id:"wine-cellar",   cat:"Food & Drink",  name:"Moravian Wine Cellar Tasting",    desc:"Guided tasting of 8 premium Moravian wines in a historic underground cellar with a sommelier.",           price:55, img:"https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?auto=format&fit=crop&w=600&q=80" },
  // River & Water
  { id:"river-cruise",  cat:"River & Water", name:"Vltava Dinner Cruise",            desc:"2-hour scenic dinner cruise with live jazz, sunset views, and full Czech dinner service.",                   price:50, img:"https://images.unsplash.com/photo-1541849546-216549ae216d?auto=format&fit=crop&w=600&q=80" },
  { id:"beer-bike",     cat:"River & Water", name:"Swimming Beer Bike",              desc:"Pedal-powered party boat on the Vltava — unlimited draft beer, great views, great laughs.",                 price:35, img:"https://images.unsplash.com/photo-1530541930197-ff16ac917b0e?auto=format&fit=crop&w=600&q=80" },
  { id:"car-boat",      cat:"River & Water", name:"Antique Car Boat Ride",           desc:"Vintage-style car boat cruise past Prague's landmarks — charming and completely unique.",                   price:30, img:"https://images.unsplash.com/photo-1500514966906-fe245eea9344?auto=format&fit=crop&w=600&q=80" },
  { id:"paddle",        cat:"River & Water", name:"Paddle Boating",                  desc:"Relaxing paddle boat on the Vltava — unique perspective on Charles Bridge and the Castle.",                  price:15, img:"https://images.unsplash.com/photo-1472745942893-4b9f730c7668?auto=format&fit=crop&w=600&q=80" },
  // Cultural
  { id:"castle-skip",   cat:"Cultural",      name:"Prague Castle Skip-the-Line",     desc:"VIP fast-track entry to the world's largest ancient castle complex. No queuing, ever.",                     price:25, img:"https://images.unsplash.com/photo-1519677100203-a0e668c92439?auto=format&fit=crop&w=600&q=80" },
  { id:"clock-tower",   cat:"Cultural",      name:"Astronomical Clock Tower",        desc:"Private after-hours climb of the clock tower for panoramic views of Old Town Square at dusk.",              price:22, img:"https://images.unsplash.com/photo-1562624475-96f01174831f?auto=format&fit=crop&w=600&q=80" },
  { id:"underground",   cat:"Cultural",      name:"Underground Prague",              desc:"Explore medieval cellars, tunnels, and secret corridors beneath Old Town — 700 years of history below.",   price:30, img:"https://images.unsplash.com/photo-1555431189-0fabf2667795?auto=format&fit=crop&w=600&q=80" },
  { id:"communist",     cat:"Cultural",      name:"Communist Prague & Nuclear Bunker",desc:"Cold War tour: secret police cells, Velvet Revolution memorial & an actual nuclear bunker.",               price:35, img:"https://images.unsplash.com/photo-1568307970720-a1551a9158c8?auto=format&fit=crop&w=600&q=80" },
  { id:"concert",       cat:"Cultural",      name:"Classical Concert — Municipal House",desc:"Live symphony orchestra in Prague's stunning Art Nouveau concert hall. Dress code: smart.",              price:40, img:"https://images.unsplash.com/photo-1507838153414-b4b713384a76?auto=format&fit=crop&w=600&q=80" },
  { id:"opera",         cat:"Cultural",      name:"Opera at the State Opera",        desc:"World-class opera in a gorgeous neo-Rococo venue. Subtitles in 3 languages.",                               price:35, img:"https://images.unsplash.com/photo-1580809361436-42a7ec204889?auto=format&fit=crop&w=600&q=80" },
  { id:"lennon",        cat:"Cultural",      name:"Lennon Wall & Street Art Tour",   desc:"Guided walk through Prague's most expressive street art scene — the story of rebellion in colour.",         price:20, img:"https://images.unsplash.com/photo-1509114397022-ed747cca3f65?auto=format&fit=crop&w=600&q=80" },
  { id:"vysehrad",      cat:"Cultural",      name:"Vyšehrad Fortress Walk",          desc:"Panoramic views, ancient basilica, and the cemetery where Czech legends are buried.",                       price:20, img:"https://images.unsplash.com/photo-1551632811-561732d1e306?auto=format&fit=crop&w=600&q=80" },
  { id:"glassblowing",  cat:"Cultural",      name:"Czech Glass Blowing Workshop",    desc:"Create your own glass piece with a master glassblower in a Bohemian studio. Keep your creation.",         price:55, img:"https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80" },
  { id:"photoshoot",    cat:"Cultural",      name:"Old Town Photography Session",    desc:"2-hour shoot with a professional photographer in Prague's most photogenic locations — at golden hour.",    price:120, img:"https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=600&q=80" },
  // Day Trips
  { id:"bohemia",       cat:"Day Trips",     name:"Bohemian Switzerland",            desc:"Full-day hike: Pravčická Gate arch, Edmund Gorge boat ride, pine forest trails.",                           price:85, img:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=600&q=80" },
  { id:"krumlov",       cat:"Day Trips",     name:"Český Krumlov",                   desc:"UNESCO fairy-tale castle town — castle tour, river rafting, medieval tavern lunch.",                        price:75, img:"https://images.unsplash.com/photo-1554401704-5cce6e787c0a?auto=format&fit=crop&w=600&q=80" },
  { id:"kutna",         cat:"Day Trips",     name:"Kutná Hora & Bone Church",        desc:"Sedlec Ossuary (the famous bone church), St. Barbara's Cathedral, silver mining history.",                 price:60, img:"https://images.unsplash.com/photo-1529260830199-42c24126f198?auto=format&fit=crop&w=600&q=80" },
  { id:"karlovy",       cat:"Day Trips",     name:"Karlovy Vary Spa Town",           desc:"Hot springs, Moser crystal glass factory, Becherovka distillery tasting, thermal spa.",                   price:70, img:"https://images.unsplash.com/photo-1507652313519-d4e9174996dd?auto=format&fit=crop&w=600&q=80" },
  // Adventure
  { id:"segway",        cat:"Adventure",     name:"Segway / E-Scooter Tour",         desc:"Glide through Prague's hidden districts and riverside paths — away from tourist crowds.",                  price:40, img:"https://images.unsplash.com/photo-1558618666-fcd25c85f82e?auto=format&fit=crop&w=600&q=80" },
  { id:"ebike",         cat:"Adventure",     name:"E-Bike River Trail",              desc:"Scenic cycling along the Vltava with stops at local riverside beer gardens.",                               price:35, img:"https://images.unsplash.com/photo-1571068316344-75bc76f77890?auto=format&fit=crop&w=600&q=80" },
  { id:"helicopter",    cat:"Adventure",     name:"Helicopter Tour of Prague",       desc:"15-minute private helicopter flight over Prague Castle, Old Town, and the Vltava. Unforgettable.",        price:220, img:"https://images.unsplash.com/photo-1534430480872-3498386e7856?auto=format&fit=crop&w=600&q=80" }
];
...
const AFTER_DARK = {
  jazz: [
    { name:"Jazz Dock", addr:"Janáčkovo nábřeží 2, Praha 5", type:"Jazz Club", desc:"Prague's finest jazz club, built directly on the Vltava riverbank. Live jazz nightly from 9pm. Book the riverside table for the best view.", price_from:15, img:"https://images.unsplash.com/photo-1415201364774-f6f0bb35f28f?auto=format&fit=crop&w=600&q=80", tip:"The whisky selection is exceptional — 80+ single malts. Arrive by 8:30pm for the best seats." },
    { name:"AghaRTA Jazz Centrum", addr:"Železná 16, Praha 1", type:"Jazz Club", desc:"Old Town's legendary jazz basement. Running since 1991, it's a Prague institution. Traditional and fusion jazz every night from 9pm.", price_from:12, img:"https://images.unsplash.com/photo-1415201364774-f6f0bb35f28f?auto=format&fit=crop&w=600&q=80", tip:"The Thursday night jam sessions are legendary. Check the website for headline acts." },
    { name:"Reduta Jazz Club", addr:"Národní 20, Praha 1", type:"Jazz Club", desc:"Prague's oldest jazz club — opened in 1958. President Clinton played here in 1994. Historic, intimate, unmissable.", price_from:14, img:"https://images.unsplash.com/photo-1415201364774-f6f0bb35f28f?auto=format&fit=crop&w=600&q=80", tip:"Book online — it sells out. The Dixieland nights on Fridays are extraordinary." }
  ],
  rooftop: [
    { name:"T-Anker Rooftop Bar", addr:"nám. Republiky 8, Praha 1", type:"Rooftop Bar", desc:"360° panoramic view of Old Town from a rooftop terrace. Best sunset view in the city. Czech craft beers and creative cocktails.", price_from:12, img:"https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?auto=format&fit=crop&w=600&q=80", tip:"Go at 7pm for golden hour. The Municipal House dome is directly opposite." },
    { name:"Cloud 9 Sky Bar & Lounge", addr:"Pobřežní 1, Praha 8 (Hilton)", type:"Sky Bar", desc:"Hilton's rooftop bar — sophisticated, quiet, and with arguably the best view of the Vltava from any bar in Prague.", price_from:15, img:"https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?auto=format&fit=crop&w=600&q=80", tip:"Dress code applies after 9pm. The espresso martini is their signature." },
    { name:"Estrella Sky Bar", addr:"Zlatnická 12, Praha 1", type:"Rooftop Bar", desc:"Open-air rooftop with a view over Charles Bridge and Prague Castle. Fire pits in winter. One of the most romantic bars in Europe.", price_from:14, img:"https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?auto=format&fit=crop&w=600&q=80", tip:"Book the VIP section for groups of 4+. The table service is excellent." }
  ],
  cocktail_bars: [
    { name:"Hemingway Bar", addr:"Karoliny Světlé 26, Praha 1", type:"Cocktail Bar", desc:"Prague's most celebrated cocktail bar. Pre-Prohibition recipes, fresh ingredients, and an atmosphere that feels genuinely 1930s. Flawless.", price_from:16, img:"https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", tip:"No reservations — queue is worth it. The Hemingway Daiquiri is non-negotiable. Ask the barman about the gin collection." },
    { name:"Black Angel's Bar", addr:"Staroměstské nám. 29, Praha 1", type:"Cocktail Bar", desc:"Hidden underground bar beneath the Old Town. Gothic arches, candlelight, and some of the most creative cocktails in Central Europe. Theatrical.", price_from:14, img:"https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", tip:"Try the Absinthe ceremony — a genuine Czech absinthe ritual performed tableside." },
    { name:"Banker's Bar", addr:"Senovážné nám. 5, Praha 1", type:"Cocktail Bar", desc:"1920s banking hall converted into a bar of extraordinary elegance. Marble columns, brass fittings, and a cocktail menu that changes monthly.", price_from:15, img:"https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", tip:"The bar food is exceptional — the wagyu sliders at midnight are remarkable." }
  ],
  shows: [
    { name:"Czech Medieval Tavern", addr:"Mostecká 21, Praha 1", type:"Dinner Show", desc:"Theatrical 5-course medieval feast with fire eaters, jesters, live music and sword fights. Unlimited mead and beer. A complete spectacle.", price:55, img:"https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=600&q=80", tip:"Book the VIP table near the stage for the best show. Vegetarian menu available on request." },
    { name:"Black Light Theatre Image", addr:"Pařížská 4, Praha 1", type:"Theatre", desc:"Prague's world-famous Black Light Theatre — an optical illusion performance unlike anything else in Europe. No language barrier. All ages.", price:28, img:"https://images.unsplash.com/photo-1524712245354-2c4e5e7121c0?auto=format&fit=crop&w=600&q=80", tip:"Sit in the centre of the stalls, not the sides. The 3D effects only work from the front." }
  ]
};
...
const ANALYTICS = {
  ...
  projected_y1: {
    ...
    avg_ticket: 55,
    properties: [
      { name:"Grand Mark Prague ★★★★★",       bookings:4120,  rev:226600,  tour:"Mucha Art Nouveau",   trend:"+18%" },
      { name:"Corinthia Prague ★★★★★",        bookings:3870,  rev:212850,  tour:"Jewish Heritage",     trend:"+12%" },
      { name:"Grand Hotel International ★★★★", bookings:2980,  rev:163900,  tour:"Kafka's Prague",      trend:"+24%" },
      { name:"Hotel Voyage ★★★★",             bookings:2450,  rev:134750,  tour:"Kids Legend Quest",   trend:"+9%"  },
