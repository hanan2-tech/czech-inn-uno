...
const TOURS = [
  {
    ...
    img: "https://images.pexels.com/photos/26385535/pexels-photo-26385535.jpeg?auto=compress&cs=tinysrgb&w=900&q=80",
  ...
  },
  {
    ...
    img: "https://images.pexels.com/photos/18501015/pexels-photo-18501015.jpeg?auto=compress&cs=tinysrgb&w=900&q=80",
  ...
  },
  {
    ...
    img: "https://images.pexels.com/photos/5974852/pexels-photo-5974852.jpeg?auto=compress&cs=tinysrgb&w=900&q=80",
  ...
  },
  {
    ...
    img: "https://images.pexels.com/photos/1352080/pexels-photo-1352080.jpeg?auto=compress&cs=tinysrgb&w=900&q=80",
...
const EXTRAS = [
  // Food & Drink
  { id:"beer-tour",     cat:"Food & Drink",  name:"Czech Food & Beer Tour",          desc:"Pub crawl through 3 historic Prague breweries with traditional Czech bites at each stop.",                    price:45, img:"https://images.pexels.com/photos/3009799/pexels-photo-3009799.jpeg?auto=compress&cs=tinysrgb&w=600&q=80" },
  { id:"beer-spa",      cat:"Food & Drink",  name:"Beer Spa Experience",             desc:"Soak in a private oak barrel of hops & malt with unlimited cold beer from your own tap.",                   price:65, img:"https://images.pexels.com/photos/5690802/pexels-photo-5690802.jpeg?auto=compress&cs=tinysrgb&w=600&q=80" },
  { id:"medieval",      cat:"Food & Drink",  name:"Medieval Dinner Show",            desc:"5-course feast with unlimited beer, fire dancers, jugglers, and swordfighting — a full spectacle.",          price:55, img:"https://images.pexels.com/photos/7919683/pexels-photo-7919683.jpeg?auto=compress&cs=tinysrgb&w=600&q=80" },
  { id:"cooking-class", cat:"Food & Drink",  name:"Czech Cooking Masterclass",       desc:"Private cooking class with a Czech chef — svíčková, trdelník, and traditional dumplings from scratch.",    price:75, img:"https://images.pexels.com/photos/2544829/pexels-photo-2544829.jpeg?auto=compress&cs=tinysrgb&w=600&q=80" },
  { id:"wine-cellar",   cat:"Food & Drink",  name:"Moravian Wine Cellar Tasting",    desc:"Guided tasting of 8 premium Moravian wines in a historic underground cellar with a sommelier.",           price:55, img:"https://images.pexels.com/photos/17765439/pexels-photo-17765439.jpeg?auto=compress&cs=tinysrgb&w=600&q=80" },
  // River & Water
  { id:"river-cruise",  cat:"River & Water", name:"Vltava Dinner Cruise",            desc:"2-hour scenic dinner cruise with live jazz, sunset views, and full Czech dinner service.",                   price:50, img:"https://images.pexels.com/photos/12999311/pexels-photo-12999311.jpeg?auto=compress&cs=tinysrgb&w=600&q=80" },
  { id:"beer-bike",     cat:"River & Water", name:"Swimming Beer Bike",              desc:"Pedal-powered party boat on the Vltava — unlimited draft beer, great views, great laughs.",                 price:35, img:"https://images.pexels.com/photos/1796705/pexels-photo-1796705.jpeg?auto=compress&cs=tinysrgb&w=600&q=80" },
  { id:"car-boat",      cat:"River & Water", name:"Antique Car Boat Ride",           desc:"Vintage-style car boat cruise past Prague's landmarks — charming and completely unique.",                   price:30, img:"https://images.pexels.com/photos/13276140/pexels-photo-13276140.jpeg?auto=compress&cs=tinysrgb&w=600&q=80" },
  { id:"paddle",        cat:"River & Water", name:"Paddle Boating",                  desc:"Relaxing paddle boat on the Vltava — unique perspective on Charles Bridge and the Castle.",                  price:15, img:"https://images.pexels.com/photos/1172569/pexels-photo-1172569.jpeg?auto=compress&cs=tinysrgb&w=600&q=80" },
  // Cultural
  ...
  { id:"lennon",        cat:"Cultural",      name:"Lennon Wall & Street Art Tour",   desc:"Guided walk through Prague's most expressive street art scene — the story of rebellion in colour.",         price:20, img:"https://images.pexels.com/photos/6424244/pexels-photo-6424244.jpeg?auto=compress&cs=tinysrgb&w=600&q=80" },
